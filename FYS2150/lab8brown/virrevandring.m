%Intialize
clear all
%Sett størrelsen på boksen
xsize=1;
ysize=1;
%Velg antall tidssteg, antall partikler og hvor langt partiklene skal
%flytte seg for hvert tidssteg
timesteps=1000; % antall tidssteg
numpart=1000; % antall partikler
stepsize=xsize/20; %1/500 av boksstørrelsen får det til å ligne på mikroskopbildene
...
%Dette gjøres for at det alltid skal vises omtrent like mange partikler i
%boksen.
